    ...
    <View style={styles.beverageItem}>
      ...
      <View style={styles.beverageInfo}>
        ...
        <View style={styles.beveragePriceRow}>
          <Text style={styles.beveragePrice}>{formatPrice(item.unitPrice)}</Text>
  ...
  return (
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.statusSection}>
        ...
        <Text style={styles.bookingId}>Mã đặt chỗ: #{booking.booking_Id}</Text>
      </View>
      ...
      <View style={styles.detailsSection}>
        ...
        <View style={styles.detailRow}>
          ...
          <Text style={styles.detailValue}>{formatDate(booking.booking_StartDate)}</Text>
        </View>
        
        <View style={styles.detailRow}>
          <Text style={styles.detailLabel}>Thời gian kết thúc:</Text>
          <Text style={styles.detailValue}>{formatDate(booking.booking_EndDate)}</Text>
        </View>
        ...
        <View style={styles.detailRow}>
          ...
          <Text style={styles.detailValue}>{booking.workspace_Capacity} người</Text>
        </View>
        ...
        <View style={styles.detailRow}>
          ...
          <Text style={styles.detailValue}>{booking.workspace_CleanTime} phút</Text>
        </View>
        ...
        <View style={styles.detailRow}>
          ...
          <Text style={styles.detailValue}>{formatDate(booking.booking_CreatedAt)}</Text>
        </View>
      ...
      {/* Amenities */}
      {booking.bookingHistoryAmenities && booking.bookingHistoryAmenities.length > 0 && (
      ...
      {/* Beverages */}
      {booking.bookingHistoryBeverages && booking.bookingHistoryBeverages.length > 0 && (
      ...
      <View style={styles.priceSection}>
        ...
        <Text style={styles.priceValue}>{formatPrice(booking.booking_Price)}</Text>
      </View>
