      ...
      <View style={styles.gridImageContainer}>
        ...
        <View style={styles.badgeContainer}>
          <View style={styles.ratingBadge}>
            ...
            <Text style={styles.ratingText}>{item.rate || 0}</Text>
          </View>
        </View>
      </View>
        ...
        <View style={styles.gridItemFooter}>
          <Text style={styles.gridItemPrice}>
            {item.prices && item.prices.length > 0
              ? formatCurrency(
                  item.prices.find((price) => price.category === "Giờ")?.price || item.prices[0].price
                )
              : "Liên hệ"}
          </Text>
      ...
      <View style={styles.imageContainer}>
        ...
        <View style={styles.badgeContainer}>
          <View style={styles.listItemRating}>
            ...
            <Text style={styles.listItemRatingText}>{item.rate || 0}</Text>
          </View>
        </View>
      </View>
